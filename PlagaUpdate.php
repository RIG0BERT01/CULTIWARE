...
$nom_plaga=$_POST['nom_plaga'];
$des_plaga=$_POST['des_plaga'];
$foto_plaga=$_POST['foto_plaga'];

$sql="UPDATE tbl_plagas SET  nom_plaga='$nom_plaga',des_plaga='$des_plaga',foto_plaga='$foto_plaga' WHERE id_plaga='$id_plaga'";
$query=mysqli_query($con,$sql);

    if($query){
        Header("Location: PlagaTabla.php");
    }
?>
