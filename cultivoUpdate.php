...
$nom_cultivo=$_POST['nom_cultivo'];
$var_cultivo=$_POST['var_cultivo'];
$hec_cultivo=$_POST['hec_cultivo'];

$sql="UPDATE tbl_cultivos SET  nom_cultivo='$nom_cultivo',var_cultivo='$var_cultivo',hec_cultivo='$hec_cultivo' WHERE id_cultivo='$id_cultivo'";
$query=mysqli_query($con,$sql);

    if($query){
        Header("Location: cultivoTabla.php"); 
    }
?>
