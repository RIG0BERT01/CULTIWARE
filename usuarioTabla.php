                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos de usuario</h1>
                                <form action="usuarioInsertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="rfc_usuario" placeholder="rfc_usuario">
                                    <input type="text" class="form-control mb-3" name="nom_usuario" placeholder="nom_usuario">
                                    <input type="text" class="form-control mb-3" name="mail_usuario" placeholder="mail_usuario">
                                    <input type="text" class="form-control mb-3" name="tel_usuario" placeholder="tel_usuario">
