...
$des_enfermedad=$_POST['des_enfermedad'];
$foto_enfermedad=$_POST['foto_enfermedad'];

$sql="UPDATE tbl_enfermedad SET  nom_enfermedad='$nom_enfermedad',des_enfermedad='$des_enfermedad',foto_enfermedad='$foto_enfermedad' WHERE id_enfermedad='$id_enfermedad'";
$query=mysqli_query($con,$sql);

    if($query){
        Header("Location: EnfermedadTabla.php");
    }
?>
