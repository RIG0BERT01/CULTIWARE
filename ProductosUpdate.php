...
$sql="UPDATE tbl_productos SET  nom_producto='$nom_producto',des_producto='$des_producto',pre_producto='$pre_producto',cat_producto='$cat_producto' WHERE id_producto='$id_producto'";
