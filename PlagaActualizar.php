...
$sql="SELECT * FROM tbl_plagas WHERE id_plaga='$id'";
...
<html lang="es">
    ...
    <body>
                <div class="container mt-5">
                    <form action="PlagaUpdate.php" method="POST">
                    
                                <input type="hidden" name="id_plaga" value="<?php echo $row['id_plaga']  ?>">
                                
                                <input type="text" class="form-control mb-3" name="nom_plaga" placeholder="nombre" value="<?php echo $row['nom_plaga']  ?>">
                                <input type="text" class="form-control mb-3" name="des_plaga" placeholder="Descripcion" value="<?php echo $row['des_plaga']  ?>">
                                <input type="text" class="form-control mb-3" name="foto_plaga" placeholder="Imagen" value="<?php echo $row['foto_plaga']  ?>">
