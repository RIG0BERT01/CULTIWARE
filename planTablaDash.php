                        ...
                        <div class="col-md-3">
                            <h1><center>P L A N E S</center></h1>
                                <form action="planInsertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="id_plan" placeholder="Id">
                                    <input type="text" class="form-control mb-3" name="tipo_plan" placeholder="Tipo de plan">
                                    <input type="text" class="form-control mb-3" name="pre_plan" placeholder="Precio">
