...
$sql="SELECT * FROM tbl_planes WHERE id_plan='$id_plan'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="planUpdate.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="tipo_plan" placeholder="tipo_plan" value="<?php echo $row['tipo_plan']  ?>">
                                <input type="text" class="form-control mb-3" name="pre_plan" placeholder="pre_plan" value="<?php echo $row['pre_plan']  ?>">
