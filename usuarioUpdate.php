...
$sql="UPDATE tbl_usuarios SET  rfc_usuario='$rfc_usuario', nom_usuario='$nom_usuario',mail_usuario='$mail_usuario',tel_usuario='$tel_usuario',user_usuario='$user_usuario',pas_usuario='$pas_usuario',tipo_usuario='$tipo_usuario',id_plan='$id_plan' WHERE id_usuario='$id_usuario'";
