...
<body>
    <nav><br><br>
        <h1 class="tittle">Perfil de Asesor</h1>

        <div class="menu-items">
            <ul class="nav-links">
                <li><a href="DashAsesor.html">
                    <i ></i><i class="fa-solid fa-house"></i>
                    <span class="link-name">Principal</span>
                </a></li>
                
                <li><a href="asesorTabla.php">
                    <i ></i><i class="fa-regular fa-user"></i>
                    <span class="link-name">Datos personales</span>
                </a></li>

                <li><a href="AsesorAgroquimicasTabla.php">
                    <i ></i><i class="fa-solid fa-flask-vial"></i>
                    <span class="link-name">Agroquimicas</span>
                </a></li>
                <li><a href="AsesorUsuarioTabla.php">
                    <i ></i><i class="fa-regular fa-user"></i>
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos de usuario</h1>
                                <form action="usuarioInsertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="id_usuario" placeholder="ID del cliente">
