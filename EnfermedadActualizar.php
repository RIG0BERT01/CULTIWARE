...
$sql="SELECT * FROM tbl_enfermedad WHERE id_enfermedad='$id'";
...
<html lang="es">
    ...
    <body>
                <div class="container mt-5">
                    <form action="EnfermedadUpdate.php" method="POST">
                    
                                <input type="hidden" name="id_enfermedad" value="<?php echo $row['id_enfermedad']  ?>">
                                
                                <input type="text" class="form-control mb-3" name="nom_enfermedad" placeholder="nombre" value="<?php echo $row['nom_enfermedad']  ?>">
                                <input type="text" class="form-control mb-3" name="des_enfermedad" placeholder="Descripcion" value="<?php echo $row['des_enfermedad']  ?>">
                                <input type="text" class="form-control mb-3" name="foto_enfermedad" placeholder="Imagen" value="<?php echo $row['foto_enfermedad']  ?>">
