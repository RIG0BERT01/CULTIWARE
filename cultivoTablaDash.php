    ...
    <body>
            <div class="container mt-5">
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1><center>C U L T I V O S</center></h1>
                                <form action="cultivoInsertar.php" method="POST">



                                    <input type="text" class="form-control mb-3" name="id_cultivo	" placeholder="Id">

                                    <input type="text" class="form-control mb-3" name="nom_cultivo" placeholder="Nombre del cultivo">

                                    <input type="text" class="form-control mb-3" name="var_cultivo" placeholder="Variedad de cultivo">

                                    <input type="text" class="form-control mb-3" name="hec_cultivo" placeholder="Hectareas del cultivo">
