...
$nom_agro=$_POST['nom_agro'];
$dir_agro=$_POST['dir_agro'];
$tel_agro=$_POST['tel_agro'];
$ubi_agro=$_POST['ubi_agro'];
$rfc_agro=$_POST['rfc_agro'];
$mail_agro=$_POST['mail_agro'];
$foto_agro=$_POST['foto_agro'];

$sql="UPDATE tbl_agroquimicas SET  nom_agro='$nom_agro',dir_agro='$dir_agro',tel_agro='$tel_agro',ubi_agro='$ubi_agro',rfc_agro='$rfc_agro',mail_agro='$mail_agro',foto_agro='$foto_agro' WHERE id_agro='$id_agro'";
$query=mysqli_query($con,$sql);

    if($query){
        Header("Location: AgroquimicasTabla.php");
    }
?>
